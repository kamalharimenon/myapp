      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDetailRow('Size:', orchid.size, textTheme),
            ...
            _buildDetailRow('Potted/Mounted:', orchid.pottingStatus, textTheme),
            _buildDetailRow('Media:', orchid.media, textTheme),
            _buildDetailRow('Location:', orchid.currentLocation, textTheme),
            _buildDetailRow('Health:', orchid.health, textTheme),
            _buildDetailRow('Light:', orchid.lightRequirement, textTheme),
            _buildDetailRow('Temperature:', orchid.temperatureRequirement, textTheme),
            const SizedBox(height: 16),
